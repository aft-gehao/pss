$(function () {
    var repair_id = $.alle_getUrlParam("repair_id");
     ...
     $("#unit").html(decodeURI($.alle_getUrlParam("unit"),"UTF-8"));
   doSearch(repair_id);
})
/*
function use_save() {
...
*/$("#submit").click(function(){
       ...
       var checking_amount=$.alle_getUrlParam("checking_amount");
       var repair_amount=$.alle_getUrlParam("repair_amount");
       var repair_id = $.alle_getUrlParam("repair_id");
       var amount=parseInt($("#amount").val())+parseInt(checking_amount);
        if(!repair_amount&&repair_amount==0)
        {
