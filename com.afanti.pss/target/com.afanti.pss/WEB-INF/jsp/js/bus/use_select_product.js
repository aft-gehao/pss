    ...
    $("#add_product").click(function () {
        ...
        $('input[name="checkbox"]').each(function () {
            if (this.checked) {
                ...
                add_product(product_id, product_name, unit, product_price, purity, space_name, space_id, batch_no, amount)
            }
        })
...
function add_product(product_id, pro_name, unit, price, purity, space_name, space_id, batch_no, amount) {
    ...
    $html += '<input id="batch_no" type="hidden" value="'+ batch_no +'">';
    ...
    $html += '</td>';
    $html += '<td><span> <input  readonly="readonly" id="purity_' + batch_no + '" value="' + purity + '" type="text" class="form-control input-sm" placeholder="" style="width: 40%;"></span></td>';
    $html += "<td>";
    ...
    $html += '<td>';
    $html += '<textarea id="desc_' + batch_no + '"   class="form-control left" rows="1" cols="15"></textarea>';
    $html += '</td>';
    $html += '<td>';
