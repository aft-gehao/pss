...
import com.afanti.psi.htmltopdf.freemaker.HtmlGenerator;
import com.afanti.psi.htmltopdf.pdf.exception.DocumentGeneratingException;
import com.afanti.psi.htmltopdf.pdf.factory.ITextRendererObjectFactory;
...
public class PdfDocumentGenerator {
	 ...
	 */
	public static boolean generate(String template, DocumentVo documentVo,
	...
	public static void generate(String htmlContent, String outputFile)
		...
		//System.out.println("ppppppp=="+htmlContent);
		try {
