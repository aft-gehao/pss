...
/**
 * Created by Administrator on 2017/6/19 0019.  》》 采购销售报表
 */
@Controller
@RequestMapping(value = "/Statistics")
public class StatisticsPurchasingController extends BaseController {
    @Autowired
    private StatisticsPurchasingService statisticsPurchasingService;

    @RequestMapping(value = "/purchasing_Chart_Show",method = RequestMethod.POST)
    @ResponseBody
    public JsonData purchasing_Chart_Show(HttpServletResponse response){
        ...
        try {
            ...
            map.put("month", sb);
            Page<PurchasingSale> list = statisticsPurchasingService.purchasing_ChartPageList(map);
            ...
            params.put("values",amount);//采购量--Z
    ...
    @RequestMapping(value = "/purchasing_Chart_Show2",method = RequestMethod.POST)
    @ResponseBody
    public JsonData purchasing_Chart_Show2(HttpServletResponse response){
        JsonData jsonData=new JsonData();
        try {
            Map<String,Object> map=new HashMap<String, Object>();
            map.put("p", getParameterString("p"));
     ...
     * @return
     */
    @RequestMapping(value="/purchasing_Chart_ShowAll",method = RequestMethod.POST)
    @ResponseBody
    public JsonData purchasing_Chart_ShowAll(){
        JsonData jsonData=new JsonData();
        Map<String,Object> map=new HashMap<String, Object>();
        map.put("p", getParameterString("p"));
        map.put("cas",getParameterString("cas"));
        map.put("year",getParameterString("year"));
        Page casList =statisticsPurchasingService.purchasing_ChartAllCASPageList(map);//cas 34
     ...
     * @return
     */
    @RequestMapping(value="/purchasing_Chart_MonthShowAll",method = RequestMethod.POST)
    @ResponseBody
    public JsonData purchasing_Chart_MonthShowAll(){
        JsonData jsonData=new JsonData();
        try {
            Map<String,Object> map=new HashMap<String, Object>();
            map.put("p", getParameterString("p"));
            ...
            map.put("month", sb);
            List<PurchasingSale> page =statisticsPurchasingService.purchasing_Chart_MonthShowAll(map);
    ...
    public JsonData showEnterDetailYear(){
        JsonData jsonData=new JsonData();
        List list=statisticsPurchasingService.showEnterDetailYear();
