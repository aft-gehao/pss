...
$("#excel_add").click(function () {
    ...
    $.ajax({
        type: 'POST',
        url: "/research/manage/researchBaobiaoAdd",
        data: {
                ...
                for (var i = 0; i < append.length; i++) {
                    ...
                    <tr >\
                        <td>' + $.alle_null2Str(append[i]["cas"]) + '</td>\
                         ...
                         <td id="but_out" >' + $.alle_null2Str(append[i]["amount"]) + '</td>\
                         <td id="but_in"  >' + $.alle_null2Str(append[i]["hours"]) + '</td>\
                     <td id="but_in" >' + $.alle_time2str_yymm_dd_hhmm(append[i]["research_time"]) + '</td>\
                        </tr>\
                    \
                    ';
                }
