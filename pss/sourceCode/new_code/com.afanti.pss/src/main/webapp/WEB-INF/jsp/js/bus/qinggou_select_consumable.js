...
function add_product(product_id,pack,pro_name,unit) {
    ...
    if (producttr) {
       ...
       $html += '<td><span id="pro_name_'+product_id+'">'+pro_name+'</span><input id="product_id_'+product_id+'" value="'+product_id+'" type="hidden"/> </td>';
        ...
        $html += '</td>';
        $html += "<td>";
        $html += '<input id="amount_' + product_id + '"type="hidden" value="10000000"><input id="space_id_' + product_id + '"type="hidden" value="">' +
        ...
        $html += unit;
        $html += "</td>";
        $html += '<td><input type="hidden" id="space_id_' + product_id + '" value=""/> <textarea id="space_name_' + product_id + '" title="" readonly="readonly" class="form-control" rows="1" cols="15"></textarea></td>';
